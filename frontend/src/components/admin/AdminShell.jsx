...
function linkClass({ isActive }) {
  return isActive
    ? 'flex items-center gap-2 rounded-lg border border-[#f4c23d]/40 bg-[#f4c23d]/15 px-3 py-2.5 text-xs font-semibold uppercase tracking-[0.08em] text-[#f4c23d] sm:text-sm'
    : 'flex items-center gap-2 rounded-lg px-3 py-2.5 text-xs font-semibold uppercase tracking-[0.08em] text-slate-300 transition-colors hover:bg-white/10 hover:text-white sm:text-sm'
}
    ...
    <main className="mx-auto w-full max-w-6xl px-3 py-4 sm:px-4 sm:py-6">
      <div className="grid gap-4 xl:grid-cols-[240px_1fr]">
        <aside className="rounded-2xl border border-[#f4c23d]/25 bg-[#1b2132]/95 p-4 shadow-lg">
          ...
          <div className="mt-4 rounded-xl border border-white/15 bg-white/5 p-3 xl:mt-6">
